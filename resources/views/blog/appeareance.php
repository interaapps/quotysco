            ...
            <input style="display: none" id="filepickeruploadinput" type="file">
                ...
                <div id="blog_user">
                    ...
                    <div id="blog_user_info">
                        ...
                        <i class="blog_user_editable_indicator material-icons">edit</i><input tooltip="Edit Description" type="text" id="blog_user_description" value="<?php echo (htmlspecialchars(str_replace("\"","\\\"",$blog["description"]))); ?>" ><br>
                        Homepage: <i class="blog_user_editable_indicator material-icons">edit</i><input id="blog_user_homepage" tooltip="Edit Homepage" type="text" value="<?php echo (htmlspecialchars(str_replace("\"","\\\"",$blog["homepage"]))); ?>" >
                    </div>
